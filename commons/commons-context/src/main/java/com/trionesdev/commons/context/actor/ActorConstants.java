...
public class ActorConstants {
    public static final String X_TRACE_ID = "X-Request-TraceId";
    public static final String X_ACTOR_ID = "X-Request-ActorId";
    public static final String X_USER_ID = "X-Request-UserId";
    ...
    public static final String X_MEMBER_ID = "X-Request-MemberId";
    ...
    public static final String MDC_TENANT_MEMBER_ID = "tenantMemberId";
