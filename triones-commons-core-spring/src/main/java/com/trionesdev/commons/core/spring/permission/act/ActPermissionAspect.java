...
import com.trionesdev.commons.exception.PermissionDeniedException;
...
public class ActPermissionAspect implements ApplicationContextAware {
    ...
    @Pointcut(value = "@annotation(com.trionesdev.commons.core.spring.permission.act.ActPermission)")
